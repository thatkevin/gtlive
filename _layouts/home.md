    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal{{ forloop.index }}">
                            <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                                <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
                            </div>
                            <img class="img-fluid" src="assets/img/bands/{{ band.name | remove: '.md' }}_circle.png" alt="{{ band.title }}" />
                        </div>
                    </div>
                    {% endfor %}
                </div>
        ...
        <section class="page-section bg-primary mb-0" id="about">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ms-auto"><p class="lead">{% include about_col1.md %}</p></div>
                    <div class="col-lg-4 me-auto"><p class="lead">{% include about_col2.md %}</p></div>
                </div>
            </div>
        </section>
        <!-- Contact Section-->
